...
(function(){
 ...
 function populateTopics(){
     ...
     sel.innerHTML='';
     // All Topics option
     const allOpt=document.createElement('option'); allOpt.value='__ALL_TOPICS__'; allOpt.textContent='All Topics'; sel.appendChild(allOpt);
